...
template<typename typeData>
bool z80::testBit(typeData inData, int pos) {
    typeData lMsk = 1 << pos;
    return (inData & lMsk) ? true : false;
}

template<typename typeData>
typeData z80::getBit(typeData inData, int pos) {
    typeData lMsk = 1 << pos;
    return lMsk;
}

template<typename typeData>
typeData z80::setBit(typeData inData, int pos) {
    typeData lMsk = 1 << pos;
    inData |= lMsk;
    return inData;
}
...
template<typename typeData>
typeData z80::resetBit(typeData inData, int pos) {
    typeData lMsk = 1 << pos;
    inData &= ~lMsk;
    return inData;
}
...
void z80::pushShortToStack(uint16_t value)
{
...
//uint16_t z80::POP16_OFF() {
//    uint16_t temp = read(sp + 1);
//
//}
...
void z80::INC_8BIT_MEM(uint16_t addr)
{
...
void z80::DEC_8BIT_MEM(uint16_t addr)
{
    uint8_t temp = read(addr);
    write(addr, (temp - 1)); //inc value
    uint8_t now = temp - 1;
...
{//obtained from another emulator's code
    ...
    //}
    //
    //if (registerAF.hi == 0) registerAF.lo |= 0x80;
    //else registerAF.lo &= ~0x80;

    int temp = registerAF.hi;

    if (!testBit(registerAF.lo, N)) {
        if (testBit(registerAF.lo, H) || (temp & 0x0F) > 9)
            temp += 6;
        if (testBit(registerAF.lo, C) || temp > 0x9F)
            temp += 0x60;
    }
    else {
        if (testBit(registerAF.lo, H)) {
            temp -= 6;
            if (!testBit(registerAF.lo, C))
                temp &= 0xFF;
        }
...
void z80::JP(int flag, bool cond)
{
    ...
    if (testBit(registerAF.lo, flag) == cond) {
        pc = nn;
    }       
}
...
{
    bool isCarrySet = testBit(registerAF.lo, C);
    bool isSet = testBit(reg, 7);
...
void z80::test_Bit(uint8_t reg, int bit)
{
...
int z80::executeOP(uint8_t opcode)
{
    ...
    case 0x67:
        ...
        return 4;
    case 0x6F:
        BIT8_LOAD(registerHL.lo, registerAF.hi);
        return 4;
    case 0x02:
    ...
    case 0xEA: {
        ...
        pc++; pc++;
        //n = read(nn);
        write(nn, registerAF.hi);
        return 16;
    }
    case 0xF2:
        nn = 0xFF00 + registerBC.lo;
        registerAF.hi = read(nn);
        return 8;
    case 0xE2:

        write((0xFF00 + registerBC.lo), registerAF.hi);
        return 8;
    ...
    case 0xF5:
        pushShortToStack(registerAF.reg);
        return 16;
    case 0xC5:
        pushShortToStack(registerBC.reg);
        return 16;
    case 0xD5:
        pushShortToStack(registerDE.reg);
        return 16;
    case 0xE5:
        pushShortToStack(registerHL.reg);
        return 16;
    case 0xF1:
        registerAF.reg = (popShortFromStack() & 0xFFF0);
        return 12;
    case 0xC1:
        registerBC.reg = popShortFromStack();
        return 12;
    case 0xD1:
        registerDE.reg = popShortFromStack();
        return 12;
    case 0xE1:
        registerHL.reg = popShortFromStack();
        return 12;
    case 0x87:
    ...
    case 0x03:
        INC_16BIT(registerBC.reg);
        return 8;
    case 0x13:
        INC_16BIT(registerDE.reg);
        return 8;
    case 0x23:
    ...
    case 0x33:
        ...
        return 8;
    case 0x0B:
        DEC_16BIT(registerBC.reg);
        return 8;
    case 0x1B:
        DEC_16BIT(registerDE.reg);
        return 8;
    case 0x2B:
...
int z80::executeExOP(uint8_t exOp) {
    ...
    //test bit 0
    case 0x47:
        test_Bit(registerAF.hi, 0);
        return 8;
    case 0x40:
        test_Bit(registerBC.hi, 0);
        return 8;
    case 0x41:
        test_Bit(registerBC.lo, 0);
        return 8;
    case 0x42:
        test_Bit(registerDE.hi, 0);
        return 8;
    case 0x43:
        test_Bit(registerDE.lo, 0);
        return 8;
    case 0x44:
        test_Bit(registerHL.hi, 0);
        return 8;
    case 0x45:
        test_Bit(registerHL.lo, 0);
        return 8;
    case 0x46:
        test_Bit(read(registerHL.reg), 0);
        return 16;
        //test bit 1
    case 0x4F:
        test_Bit(registerAF.hi, 1);
        return 8;
    case 0x48:
        test_Bit(registerBC.hi, 1);
        return 8;
    case 0x49:
        test_Bit(registerBC.lo, 1);
        return 8;
    case 0x4A:
        test_Bit(registerDE.hi, 1);
        return 8;
    case 0x4B:
        test_Bit(registerDE.lo, 1);
        return 8;
    case 0x4C:
        test_Bit(registerHL.hi, 1);
        return 8;
    case 0x4D:
        test_Bit(registerHL.lo, 1);
        return 8;
    case 0x4E:
        test_Bit(read(registerHL.reg), 1);
        return 16;
        //test bit 2
    case 0x57:
        test_Bit(registerAF.hi, 2);
        return 8;
    case 0x50:
        test_Bit(registerBC.hi, 2);
        return 8;
    case 0x51:
        test_Bit(registerBC.lo, 2);
        return 8;
    case 0x52:
        test_Bit(registerDE.hi, 2);
        return 8;
    case 0x53:
        test_Bit(registerDE.lo, 2);
        return 8;
    case 0x54:
        test_Bit(registerHL.hi, 2);
        return 8;
    case 0x55:
        test_Bit(registerHL.lo, 2);
        return 8;
    case 0x56:
        test_Bit(read(registerHL.reg), 2);
        return 16;
        //test bit 3
    case 0x5F:
        test_Bit(registerAF.hi, 3);
        return 8;
    case 0x58:
        test_Bit(registerBC.hi, 3);
        return 8;
    case 0x59:
        test_Bit(registerBC.lo, 3);
        return 8;
    case 0x5A:
        test_Bit(registerDE.hi, 3);
        return 8;
    case 0x5B:
        test_Bit(registerDE.lo, 3);
        return 8;
    case 0x5C:
        test_Bit(registerHL.hi, 3);
        return 8;
    case 0x5D:
        test_Bit(registerHL.lo, 3);
        return 8;
    case 0x5E:
        test_Bit(read(registerHL.reg), 3);
        return 16;
        //test bit 4
    case 0x67:
        test_Bit(registerAF.hi, 4);
        return 8;
    case 0x60:
        test_Bit(registerBC.hi, 4);
        return 8;
    case 0x61:
        test_Bit(registerBC.lo, 4);
        return 8;
    case 0x62:
        test_Bit(registerDE.hi, 4);
        return 8;
    case 0x63:
        test_Bit(registerDE.lo, 4);
        return 8;
    case 0x64:
        test_Bit(registerHL.hi, 4);
        return 8;
    case 0x65:
        test_Bit(registerHL.lo, 4);
        return 8;
    case 0x66:
        test_Bit(read(registerHL.reg), 4);
        return 16;
        //test bit 5
    case 0x6F:
        test_Bit(registerAF.hi, 5);
        return 8;
    case 0x68:
        test_Bit(registerBC.hi, 5);
        return 8;
    case 0x69:
        test_Bit(registerBC.lo, 5);
        return 8;
    case 0x6A:
        test_Bit(registerDE.hi, 5);
        return 8;
    case 0x6B:
        test_Bit(registerDE.lo, 5);
        return 8;
    case 0x6C:
        test_Bit(registerHL.hi, 5);
        return 8;
    case 0x6D:
        test_Bit(registerHL.lo, 5);
        return 8;
    case 0x6E:
        test_Bit(read(registerHL.reg), 5);
        return 16;
        //test bit 6
    case 0x77:
        test_Bit(registerAF.hi, 6);
        return 8;
    case 0x70:
        test_Bit(registerBC.hi, 6);
        return 8;
    case 0x71:
        test_Bit(registerBC.lo, 6);
        return 8;
    case 0x72:
        test_Bit(registerDE.hi, 6);
        return 8;
    case 0x73:
        test_Bit(registerDE.lo, 6);
        return 8;
    case 0x74:
        test_Bit(registerHL.hi, 6);
        return 8;
    case 0x75:
        test_Bit(registerHL.lo, 6);
        return 8;
    case 0x76:
        test_Bit(registerHL.reg, 6);
        return 16;
        //test bit 7
    case 0x7F:
        test_Bit(registerAF.hi, 7);
        return 8;
    case 0x78:
        test_Bit(registerBC.hi, 7);
        return 8;
    case 0x79:
        test_Bit(registerBC.lo, 7);
        return 8;
    case 0x7A:
        test_Bit(registerDE.hi, 7);
        return 8;
    case 0x7B:
        test_Bit(registerDE.lo, 7);
        return 8;
    case 0x7C:
        test_Bit(registerHL.hi, 7);
        return 8;
    case 0x7D:
        test_Bit(registerHL.lo, 7);
        return 8;
    case 0x7E:
        test_Bit(read(registerHL.reg), 7);
        return 16;
    //Reset bit 0
    case 0x87:
        RES(registerAF.hi, 0);
